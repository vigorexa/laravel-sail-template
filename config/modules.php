...
return [
    ...
    */
    'stubs' => [
        ...
        'files' => [
            ...
            // Модули собираются корневым vite.config.js, поэтому свои
            // vite.config.js и package.json им не нужны.
            // 'vite' => 'vite.config.js',
        ...
        'replacements' => [
            ...
            'assets/js/app' => ['LOWER_NAME', 'STUDLY_NAME', 'KEBAB_NAME'],
            'assets/css/app' => ['LOWER_NAME', 'STUDLY_NAME', 'KEBAB_NAME'],
    ...
    */
    'commands' => ConsoleServiceProvider::defaultCommands()
        ->merge([
            ModuleMakeFilamentPluginCommand::class,
        ])->toArray(),
    ...
    */
    'composer' => [
        'vendor' => env('MODULE_VENDOR', 'vigorexa'),
        'author' => [
